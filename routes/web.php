...
Route::group(['prefix' => 'mechanics'], function () {
    ...
    Route::get('pdf{mechanic}', 'MechanicController@pdf')->name('mechanic.pdf');
    Route::get('download{mechanic}', 'MechanicController@download')->name('mechanic.download');
    Route::get('filter/', 'MechanicController@filter')->name('mechanic.filter');
    Route::post('get-filter/', 'MechanicController@getFilter')->name('mechanic.get-filter');
});
